...
}()); var now = -1; var resLength = 0; var thisSearch = 'https://www.baidu.com/s?wd='; var thisSearchIcon = './images/search/baidu.png'; var storage = window.localStorage; if (!storage.stopHot) { storage.stopHot = true }
...
$(function () {
    var search = { data: [{ name: '百度', img: './images/search/baidu.png', url: 'https://www.baidu.com/s?wd=' }, { name: 'Google', img: './images/search/google.png', url: 'https://www.google.com?q=' }, { name: '360搜', img: './images/search/360.png', url: 'https://www.so.com/s?q=' }, { name: '搜狗', img: './images/search/sougou.png', url: 'https://www.sogou.com/web?query=' }, { name: 'Bing', img: './images/search/bing.png', url: 'https://bing.com?q=' }, { name: 'YaHoo', img: './images/search/yahoo.png', url: 'https:/.yahoo.com?p=' }, { name: '神马', img: './images/search/shenma.png', url: 'http://quark.sm.cn/s?q=' }, { name: '秘迹', img: './images/search/miji.png', url: 'https://mijisou.com/?q=' }, { name: 'Duckgo', img: './images/search/Duckduckgo.png', url: 'https://duckduckgo.com/?q=' }, { name: 'YaHooJP', img: './images/search/yahoojp.png', url: 'https:/.yahoo.co.jp?p=' }, { name: 'Lookao', img: './images/search/lookao.png', url: 'https://lookao.com?q=' }, { name: 'Yandex', img: './images/search/yandex.png', url: 'https://yandex.com/./?text=' }, { name: 'AOl', img: './images/search/aol.png', url: 'http:/.aol.com/aol?q=' }, { name: 'Yippy', img: './images/search/yippy.png', url: 'https://yippy.com?query=' }, { name: 'Startpage', img: './images/search/startpage.png', url: 'https://www.startpage.com/do/dsearch?query=' }, { name: 'Ecosia', img: './images/search/Ecosia.png', url: 'https://www.ecosia.org?q=' }, { name: 'Peekier', img: './images/search/peekier.png', url: 'https://peekier.com/#!' }, { name: 'Qwant', img: './images/search/qwant.png', url: 'https://www.qwant.com/?q=' }, { name: 'MetaGer', img: './images/search/metager.png', url: 'https://metager.de/meta/meta.ger3?eingabe=' }, { name: 'Dogpile', img: './images/search/dogpile.png', url: 'https://www.dogpile.com/serp?q=' }, { name: 'Mag[i]', img: './images/search/magi.png', url: 'https://magi.com?q=' }, { name: 'Goobe', img: './images/search/goobe.png', url: 'https://goobe.io.aspx?k=' }, { name: 'Torrentz2', img: './images/search/torrentz2.png', url: 'https://torrentz2.eu?f=' }, { name: 'Acg搜', img: './images/search/acgsou.png', url: 'http://www.acgsou.com.php?keyword=' }] }
